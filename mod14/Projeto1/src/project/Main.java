...
import project.dao.ClienteSetDAO;
import project.dao.iClienteDAO;
...
public class Main {
    ...
    private static void atualizar(String dados) {
        ...
        Cliente cliente = new Cliente(dadosSeparados[0],Long.parseLong(dadosSeparados[1]),Long.parseLong(dadosSeparados[2]),dadosSeparados[3],Integer.valueOf(dadosSeparados[4]),dadosSeparados[5],dadosSeparados[6]);
    ...
    private static void sair() {
        StringJoiner clientesCadastrados = new StringJoiner("\n");
        iClienteDAO.buscarTodosOsClientes().forEach(cliente -> clientesCadastrados.add(cliente.toString()));
